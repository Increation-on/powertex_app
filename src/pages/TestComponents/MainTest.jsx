    ...
    <>
      <main className={styles.main}>
        ...
        <div className={styles.main_wave}>
          {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d=""></path></svg> */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffffff" fill-opacity="1" d="M0,160L120,181.3C240,203,480,245,720,266.7C960,288,1200,288,1320,288L1440,288L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
        </div>
        ...
        <div className={styles.main_products}>
          ...
          <div className={styles.products_wrapper}>
            {products ? products.map(product => {
              return (
                product.id <= 4 ? <Suspense key={product.id} fallback={<ProductCardFallback key={product.id} product={product} />}>
